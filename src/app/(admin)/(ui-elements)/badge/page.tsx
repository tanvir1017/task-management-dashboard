...
export const metadata: Metadata = {
  title: "Next.js Badge | Task Management - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Task Management - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
