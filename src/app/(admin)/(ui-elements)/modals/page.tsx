...
export const metadata: Metadata = {
  title: "Next.js Modals | Task Management - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Task Management - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
