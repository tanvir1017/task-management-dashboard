...
export const metadata: Metadata = {
  title: "Next.js Avatars | Task Management - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Task Management - Next.js Tailwind CSS Admin Dashboard Template",
};
